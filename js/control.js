...
function createArea(content,ident){
	...
	dvn('#'+ident).divText({
		...
		text:/txtHeader/.test(ident)?'<head>\n\n<!-- libs and stylesheets here -->\n\n'+((editorText.header!=undefined)?editorText.header:null)+'</head>':
			 /txtHtml/.test(ident)?((editorText.hasOwnProperty('html'))?editorText.html:null):
			 /txtCss/.test(ident)?((editorText.hasOwnProperty('css'))?editorText.css:null):
			 /txtJs/.test(ident)?((editorText.hasOwnProperty('js'))?editorText.js:null):null
	});
